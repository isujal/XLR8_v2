...
//@TeleOp(name = "CRServoTurret_AprilTag", group = "ProtoTypes")
//@Config
@Disabled
@Deprecated
public class final_turret_tracking extends LinearOpMode {
...
//    public static int ENCODER_TICKS_PER_REV = 8192 ;
    public static int ENCODER_TICKS_PER_REV = 27846 ;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            if (tagVisible) {
                ...
                fieldTargetHeading = normalizeFull(Math.toDegrees(robotHeading) + tagYawDeg);
            }
...
//            telemetry.addData("Yaw", "%.2f",detections.get(0).ftcPose.yaw );
            ...
            telemetry.addData("ActualEncoValue", turretEncoder.getCurrentPosition());
