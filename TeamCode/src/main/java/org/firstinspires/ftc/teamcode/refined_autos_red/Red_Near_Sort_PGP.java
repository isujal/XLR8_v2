package org.firstinspires.ftc.teamcode.refined_autos_red;
...
//@Deprecated
public class Red_Near_Sort_PGP extends LinearOpMode {
...
//
        ...
        Action trajectoryAction3 = drive.actionBuilder(new Pose2d(-7, 16.01,Math.toRadians(90)))
                ...
                .strafeToLinearHeading(new Vector2d(-7, 35), Math.toRadians(90), vel, accel0)
                .waitSeconds(0.1)
                .strafeToLinearHeading(new Vector2d(-7, 55), Math.toRadians(90), vel, accel2)
        ...
        Action trajectoryAction4 = drive.actionBuilder(new Pose2d(-7, 55.01,Math.toRadians(90)))

                .strafeToLinearHeading(new Vector2d(-7, 16), Math.toRadians(90))
                .build();


        Action trajectoryAction4x = drive.actionBuilder(new Pose2d(-7, 55,Math.toRadians(90)))
                .stopAndAdd(()->
                        new RollerCommand(intake,Intake.IntakeRollerState.ON))
                .strafeToConstantHeading(new Vector2d(-7, 55.01))
                .waitSeconds(0.05)
        ...
        Action trajectoryAction5 = drive.actionBuilder(new Pose2d(-7, 16,Math.toRadians(90)))
        ...
        Action trajectoryAction6 = drive.actionBuilder(new Pose2d(-7, 16,Math.toRadians(90)))
                .afterTime(0.01,() ->Actions.runBlocking(
                                new SequentialAction(
                                        new InstantAction(()-> new UFCommand(feeder,Feeder.UpperFeederState.OFF)),
                                        new InstantAction(()-> new LFCommand(feeder,Feeder.LowerFeederState.ON))
        ...
        Action trajectoryAction6x = drive.actionBuilder(new Pose2d(18, 32,Math.toRadians(90)))

                .strafeToLinearHeading(new Vector2d(18, 60), Math.toRadians(90), vel,accel0)
        ...
        Action trajectoryAction7 = drive.actionBuilder(new Pose2d(18, 60.01,Math.toRadians(90)))

                .strafeToLinearHeading(new Vector2d(-7, 16), Math.toRadians(90))
                .build();


        Action trajectoryAction7x = drive.actionBuilder(new Pose2d(18, 60,Math.toRadians(90)))
                .stopAndAdd(()->
                        new RollerCommand(intake,Intake.IntakeRollerState.ON))
        ...
        Action trajectoryAction8 = drive.actionBuilder(new Pose2d(-7, 16,Math.toRadians(90)))
                .waitSeconds(0.1)
                .stopAndAdd(()->Actions.runBlocking(new SequentialAction(
                        new InstantAction(()-> new UFCommand(feeder,Feeder.UpperFeederState.ON)),
                        new SleepAction(0.3),
...
//                .waitSeconds(0.1)
        ...
        Action trajectoryAction9x = drive.actionBuilder(new Pose2d(40.5, 32,Math.toRadians(90)))

                .strafeToLinearHeading(new Vector2d(40.5, 40), Math.toRadians(90), vel, accel2)
                .waitSeconds(0.2)
        ...
        Action trajectoryAction10 = drive.actionBuilder(new Pose2d(40.5, 58.01,Math.toRadians(90)))

                .strafeToLinearHeading(new Vector2d(-7, 16), Math.toRadians(90))
                .build();


        Action trajectoryAction10x = drive.actionBuilder(new Pose2d(40.5, 58,Math.toRadians(90)))
                .stopAndAdd(()->
                        new RollerCommand(intake,Intake.IntakeRollerState.ON))
        ...
        Action trajectoryAction11 = drive.actionBuilder(new Pose2d(-7, 16,Math.toRadians(90)))
...
//                    gamepad1.rumble(1, 1, 400);
                    ...
                    if (state == 3  && Globals.counterFeed_PGPtoPPG == 0)
                    {
//                thirdBallFlag = false;
...
//                        Actions.runBlocking(IntakeSeq.IntakeStoreAction2(intake,outtake,feeder));
                    ...
                    if (!robot.outtakeBeam.getState() && Globals.counterFeed_PGPtoPPG==0 && state == 3 ){
...
//                        );
                    ...
                    if (Globals.counterFeed_PGPtoPPG==1 && !robot.intakeBeam.getState()&& state == 3 ){
                        Globals.counterFeed_PGPtoPPG += 1;
...
//                zeroFlag = true;
                    ...
                    if (Globals.counterFeed_PGPtoPPG==2 && robot.intakeBeam.getState()&& state == 3 ){
                        Globals.counterFeed_PGPtoPPG += 1;
                    ...
                    if (Globals.counterFeed_PGPtoPPG==3 && !robot.intakeBeam.getState()&& state == 3 ){
                        Globals.counterFeed_PGPtoPPG += 1;
                    ...
                    if (Globals.counterFeed_PGPtoPPG==4 && !robot.feederBeam.getState()&& state == 3 ){
//                motionFlag = true;
//                motionTimer.reset();
...
//                zeroFlag = true;
                    ...
                    if (Globals.counterFeed_GPPtoPPG==3 && !robot.intakeBeam.getState()&& state ==15){
                        Globals.counterFeed_GPPtoPPG += 1;
                        Actions.runBlocking(
                                new ParallelAction(
                                        Intake.IntakeCommand(Intake.IntakeServoState.IN),
...
//                zeroFlag = true;
                    ...
                    if (Globals.counterFeed_GPPtoPPG==4 && robot.intakeBeam.getState()&& state ==15){
                        Globals.counterFeed_GPPtoPPG += 1;
                        Actions.runBlocking(
                                new ParallelAction(
                                        Intake.IntakeCommand(Intake.IntakeServoState.IN),
                    ...
                    if (Globals.counterFeed_GPPtoPPG==5 && !robot.intakeBeam.getState()&& state ==15){
//                        Globals.counterFeed_GPPtoPPG += 1;
