...
//@Deprecated
public class Red_Far_PGP extends LinearOpMode {
...
//
        ...
        Action trajectoryAction7 = drive.actionBuilder(new Pose2d(10, 30,Math.toRadians(90)))

                .strafeToConstantHeading(new Vector2d(10, 60),vel,accel2)
                .build();

        Action trajectoryAction8 = drive.actionBuilder(new Pose2d(10, 60.01,Math.toRadians(90)))

                .strafeToConstantHeading(new Vector2d(47, 9))
                .build();


        Action trajectoryAction8x = drive.actionBuilder(new Pose2d(10, 60,Math.toRadians(90)))
                .stopAndAdd(()->
                        new RollerCommand(intake,Intake.IntakeRollerState.ON))
                .strafeToConstantHeading(new Vector2d(10, 60.01))
                .waitSeconds(0.1)
                .stopAndAdd(()->Actions.runBlocking(new ParallelAction(
                        new InstantAction(()-> new RollerCommand(intake,Intake.IntakeRollerState.ON)),
                        new InstantAction(()-> new UFCommand(feeder,Feeder.UpperFeederState.OFF)),
