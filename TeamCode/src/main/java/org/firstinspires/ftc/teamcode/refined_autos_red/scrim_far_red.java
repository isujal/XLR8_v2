...
@Config
//@Autonomous(name="SB AUTO FAR SCRIM OG🔴")
//@Deprecated
public class scrim_far_red extends LinearOpMode {
...
//
        ...
        Action trajectoryAction10 = drive.actionBuilder(new Pose2d(47, 9,Math.toRadians(90)))
                .afterTime(0.01,() ->Actions.runBlocking(
                                new SequentialAction(
                                        new InstantAction(()-> new UFCommand(feeder,Feeder.UpperFeederState.OFF)),
                                        new InstantAction(()-> new LFCommand(feeder,Feeder.LowerFeederState.ON))
                ...
                .strafeToLinearHeading(new Vector2d(62,76), Math.toRadians(48))
                .strafeToLinearHeading(new Vector2d(84, 78), Math.toRadians(0),vel, accel)
                .strafeToLinearHeading(new Vector2d(98, 75), Math.toRadians(0),vel, accel)


//                .splineToLinearHeading(new Pose2d(70,70,Math.toRadians(45)), Math.toRadians(45), vel,accel)
                .build();
//
//        Action trajectoryAction11 = drive.actionBuilder(new Pose2d(62, 76,Math.toRadians(48)))
//
//                .build();
//
//        Action trajectoryAction12x = drive.actionBuilder(new Pose2d(84, 78,Math.toRadians(0)))
//
//                .build();

        Action trajectoryAction12 = drive.actionBuilder(new Pose2d(98, 75,Math.toRadians(0)))
                .stopAndAdd(()->Actions.runBlocking(new ParallelAction(
                        new InstantAction(()-> new RollerCommand(intake,Intake.IntakeRollerState.OFF)),
                        new InstantAction(()-> new UFCommand(feeder,Feeder.UpperFeederState.OFF)),
                        new InstantAction(()-> new LFCommand(feeder,Feeder.LowerFeederState.OFF))
...
//
        Action trajectoryAction13 = drive.actionBuilder(new Pose2d(47, 9,Math.toRadians(90)))
...
//                .build();
        ...
        Action trajectoryAction14 = drive.actionBuilder(new Pose2d(47, 9,Math.toRadians(90)))
                .afterTime(0.01,() ->Actions.runBlocking(
                                new SequentialAction(
                                        new InstantAction(()-> new UFCommand(feeder,Feeder.UpperFeederState.OFF)),
                                        new InstantAction(()-> new LFCommand(feeder,Feeder.LowerFeederState.ON))
...
//                .splineToLinearHeading(new Pose2d(70,70,Math.toRadians(45)), Math.toRadians(45), vel,accel)
        ...
        Action trajectoryAction16 = drive.actionBuilder(new Pose2d(47, 9,Math.toRadians(90)))
...
//                    gamepad1.rumble(1, 1, 400);
                    ...
                    if (!robot.feederBeam.getState() && counterFeed == 0 && state == 19) {
                        counterFeed += 1;
                    }
                    if (robot.feederBeam.getState() && counterFeed == 1 && state == 19   ) {
                        counterFeed += 1;
                    }
                    if (counterFeed == 2 && !robot.feederBeam.getState() && state == 19) {
                        counterFeed += 1;
                    }
                    if (counterFeed == 3 && robot.feederBeam.getState() && state == 19) {
                        counterFeed += 1;
                        Actions.runBlocking(
                                new ParallelAction(
                                        Feeder.LFCommand(Feeder.LowerFeederState.OFF)
                    ...
                    if (counterFeed == 4 && !robot.intakeBeam.getState() && state == 19) {
                        counterFeed += 1;
                    }
                    if (counterFeed == 5 && robot.intakeBeam.getState() && state == 19) {
//                motionFlag = true;
//                motionTimer.reset();
                        counterFeed = 0;
//                    gamepad1.rumble(1, 1, 400);
...
//            robot.shooter.setVelocityPIDFCoefficients(P,I,D,F);
            ...
            if (state ==19 && intakeTimer.milliseconds()>intakeTime)
            {
                counterFeed = 0;
                state = 20;
                intakeTimer.reset();
