...
//
        ...
        Action trajectoryAction3 = drive.actionBuilder(new Pose2d(-7, 16.01,Math.toRadians(90)))
                ...
                .strafeToLinearHeading(new Vector2d(-7, 55), Math.toRadians(90), vel, accel)
        ...
        Action trajectoryAction4y = drive.actionBuilder(new Pose2d(-7, 55.01,Math.toRadians(90)))

                .strafeToLinearHeading(new Vector2d(6, 44), Math.toRadians(90))
                .waitSeconds(0.1)
                .strafeToLinearHeading(new Vector2d(6, 56), Math.toRadians(90))
                .waitSeconds(0.3)
                .build();
...
//                )
        ...
        Action trajectoryAction9x = drive.actionBuilder(new Pose2d(40.5, 32,Math.toRadians(90)))
                ...
                .strafeToLinearHeading(new Vector2d(40.5, 58), Math.toRadians(90), vel, accel)
...
//            error = -error;
            ...
            pid = Globals.kp_turret*error + Globals.kd_turret*derivative + Globals.ki_turret*integral;
