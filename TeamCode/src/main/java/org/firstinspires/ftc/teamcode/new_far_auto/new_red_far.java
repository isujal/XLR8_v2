package org.firstinspires.ftc.teamcode.new_far_auto;
...
//        new InstantAction(() -> new RollerCommand(intake, Intake.IntakeRollerState.ON)),
        ...
        Action trajectoryAction = drive.actionBuilder(startPose)
                ...
                .strafeToLinearHeading(new Vector2d(47,17), Math.toRadians(150))
                .waitSeconds(2.5)
...
//
        ...
        Action trajectoryAction2 = drive.actionBuilder(new Pose2d(47, 17,Math.toRadians(150)))
        ...
        Action trajectoryAction4x = drive.actionBuilder(new Pose2d(30, 60,Math.toRadians(90)))
                ...
                .strafeToConstantHeading(new Vector2d(30, 60.01))
                .waitSeconds(0.1)
        ...
        Action trajectoryAction5 = drive.actionBuilder(new Pose2d(47, 17,Math.toRadians(150)))
...
//
        ...
        Action trajectoryAction6 = drive.actionBuilder(new Pose2d(47, 17,Math.toRadians(150)))
                .afterTime(0.01,() ->Actions.runBlocking(
                                new SequentialAction(
                                        new InstantAction(()-> new UFCommand(feeder,Feeder.UpperFeederState.OFF)),
                                        new InstantAction(()-> new LFCommand(feeder,Feeder.LowerFeederState.ON))
        ...
        Action trajectoryAction7 = drive.actionBuilder(new Pose2d(8, 30,Math.toRadians(90)))
                ...
                .strafeToConstantHeading(new Vector2d(8, 60), vel, accel)
                .build();
        ...
        Action trajectoryAction9 = drive.actionBuilder(new Pose2d(47, 17,Math.toRadians(150)))
...
//
        ...
        Action trajectoryAction10 = drive.actionBuilder(new Pose2d(47, 17,Math.toRadians(150)))
                .afterTime(0.01,() ->Actions.runBlocking(
                                new SequentialAction(
                                        new InstantAction(()-> new UFCommand(feeder,Feeder.UpperFeederState.OFF)),
                                        new InstantAction(()-> new LFCommand(feeder,Feeder.LowerFeederState.ON))
                ...
                .strafeToLinearHeading(new Vector2d(65, 65),Math.toRadians(150),vel,accel)

//                .splineToLinearHeading(new Pose2d(70,70,Math.toRadians(45)), Math.toRadians(45), vel,accel)
                .build();


        Action trajectoryAction12 = drive.actionBuilder(new Pose2d(65, 65.01,Math.toRadians(90)))
        ...
        Action trajectoryAction12x = drive.actionBuilder(new Pose2d(65, 65,Math.toRadians(90)))
                .stopAndAdd(()->
                        new RollerCommand(intake,Intake.IntakeRollerState.ON))
                .strafeToConstantHeading(new Vector2d(65, 65.01))
                .waitSeconds(0.1)
                .stopAndAdd(()->Actions.runBlocking(new ParallelAction(
                        new InstantAction(()-> new RollerCommand(intake,Intake.IntakeRollerState.ON)),
                        new InstantAction(()-> new UFCommand(feeder,Feeder.UpperFeederState.OFF)),
        ...
        Action trajectoryAction13 = drive.actionBuilder(new Pose2d(47, 17,Math.toRadians(150)))
...
//
        ...
        Action trajectoryAction14 = drive.actionBuilder(new Pose2d(47, 17,Math.toRadians(150)))
                .afterTime(0.01,() ->Actions.runBlocking(
                                new SequentialAction(
                                        new InstantAction(()-> new UFCommand(feeder,Feeder.UpperFeederState.OFF)),
                                        new InstantAction(()-> new LFCommand(feeder,Feeder.LowerFeederState.ON))
                ...
                .strafeToLinearHeading(new Vector2d(60, 65),Math.toRadians(150),vel,accel)

//                .splineToLinearHeading(new Pose2d(70,70,Math.toRadians(45)), Math.toRadians(45), vel,accel)
                .build();


        Action trajectoryAction15 = drive.actionBuilder(new Pose2d(60, 65.01,Math.toRadians(90)))
        ...
        Action trajectoryAction15x = drive.actionBuilder(new Pose2d(60, 65,Math.toRadians(90)))
                .stopAndAdd(()->
                        new RollerCommand(intake,Intake.IntakeRollerState.ON))
                .strafeToConstantHeading(new Vector2d(60, 65.01))
                .waitSeconds(0.1)
                .stopAndAdd(()->Actions.runBlocking(new ParallelAction(
                        new InstantAction(()-> new RollerCommand(intake,Intake.IntakeRollerState.ON)),
                        new InstantAction(()-> new UFCommand(feeder,Feeder.UpperFeederState.OFF)),
        ...
        Action trajectoryAction16 = drive.actionBuilder(new Pose2d(47, 17,Math.toRadians(150)))
...
//                    gamepad1.rumble(1, 1, 400);
            ...
            if (!robot.feederBeam.getState() && counterFeed == 0 && state == 13) {
                counterFeed += 1;
            }
            if (robot.feederBeam.getState() && counterFeed == 1 && state == 13   ) {
                counterFeed += 1;
            }
            if (counterFeed == 2 && !robot.feederBeam.getState() && state == 13) {
                counterFeed += 1;
            }
            if (counterFeed == 3 && robot.feederBeam.getState() && state == 13) {
                counterFeed += 1;
                Actions.runBlocking(
                        new ParallelAction(
                                Feeder.LFCommand(Feeder.LowerFeederState.OFF)
            ...
            if (counterFeed == 4 && !robot.intakeBeam.getState() && state == 13) {
                counterFeed += 1;
            }
            if (counterFeed == 5 && robot.intakeBeam.getState() && state == 13) {
//                motionFlag = true;
//                motionTimer.reset();
                counterFeed = 0;
//                    gamepad1.rumble(1, 1, 400);
            ...
            if (!robot.feederBeam.getState() && counterFeed == 0 && state == 20) {
                counterFeed += 1;
            }
            if (robot.feederBeam.getState() && counterFeed == 1 && state == 20   ) {
                counterFeed += 1;
            }
            if (counterFeed == 2 && !robot.feederBeam.getState() && state == 20) {
                counterFeed += 1;
            }
            if (counterFeed == 3 && robot.feederBeam.getState() && state == 20) {
                counterFeed += 1;
                Actions.runBlocking(
                        new ParallelAction(
                                Feeder.LFCommand(Feeder.LowerFeederState.OFF)
            ...
            if (counterFeed == 4 && !robot.intakeBeam.getState() && state == 20) {
                counterFeed += 1;
            }
            if (counterFeed == 5 && robot.intakeBeam.getState() && state == 20) {
//                motionFlag = true;
//                motionTimer.reset();
                counterFeed = 0;
//                    gamepad1.rumble(1, 1, 400);
...
//            robot.shooter.setVelocityPIDFCoefficients(P,I,D,F);
            ...
            if (state ==14 && intakeTimer.milliseconds()>intakeTime)
            {
                counterFeed = 0;
                state = 15;
                intakeTimer.reset();
            ...
            if (state ==20 && intakeTimer.milliseconds()>intakeTime)
            {
                counterFeed = 0;
                state = 21;
                intakeTimer.reset();
