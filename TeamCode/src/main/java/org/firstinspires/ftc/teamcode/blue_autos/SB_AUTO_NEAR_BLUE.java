...
@Config
//@Autonomous(name="SB AUTO NEAR 🔵")
//@Deprecated
public class SB_AUTO_NEAR_BLUE extends LinearOpMode {
    ...
    public static int intakeTime = 1000;
...
//        new InstantAction(() -> new RollerCommand(intake, Intake.IntakeRollerState.ON)),
        ...
        Action trajectoryAction0 = drive.actionBuilder(new Pose2d(0, 0,Math.toRadians(0)))
                ...
                .strafeToLinearHeading(new Vector2d(27, 38.01), Math.toRadians(-52))
        ...
        Action trajectoryAction = drive.actionBuilder(new Pose2d(27, 38.01,Math.toRadians(-52)))
                ...
                .waitSeconds(0.05)
                .strafeToLinearHeading(new Vector2d(27,38), Math.toRadians(-52))
                .waitSeconds(0.1)
                .stopAndAdd(()->Actions.runBlocking(new SequentialAction(
                        new InstantAction(()-> new UFCommand(feeder,Feeder.UpperFeederState.ON)),
                        new SleepAction(0.3),
...
//
        ...
        Action trajectoryAction2 = drive.actionBuilder(new Pose2d(27, 38,Math.toRadians(-52)))

                .strafeToLinearHeading(new Vector2d(27, 38.01), Math.toRadians(-52))
                .build();

        Action trajectoryAction3 = drive.actionBuilder(new Pose2d(27, 38.01,Math.toRadians(-52)))

                .strafeToLinearHeading(new Vector2d(52, 9), Math.toRadians(-52))
                .build();



        Action trajectoryAction4 = drive.actionBuilder(new Pose2d(52, 9.01,Math.toRadians(-52)))
        ...
        Action trajectoryAction4x = drive.actionBuilder(new Pose2d(52, 9,Math.toRadians(-52)))
                .stopAndAdd(()->
        ...
        Action trajectoryAction5 = drive.actionBuilder(new Pose2d(27, 38,Math.toRadians(-52)))
...
//
        ...
        Action trajectoryAction6 = drive.actionBuilder(new Pose2d(27, 38,Math.toRadians(-52)))

                .strafeToConstantHeading(new Vector2d(53, 45))
                .build();

        Action trajectoryAction7 = drive.actionBuilder(new Pose2d(53, 45,Math.toRadians(-52)))

                .strafeToConstantHeading(new Vector2d(75, 20))
                .build();

        Action trajectoryAction8 = drive.actionBuilder(new Pose2d(75, 20.01,Math.toRadians(-52)))
        ...
        Action trajectoryAction8x = drive.actionBuilder(new Pose2d(75, 20,Math.toRadians(-52)))
                .stopAndAdd(()->
                        new RollerCommand(intake,Intake.IntakeRollerState.ON))
        ...
        Action trajectoryAction9 = drive.actionBuilder(new Pose2d(27, 38,Math.toRadians(-52)))
...
//                .waitSeconds(0.1)
        ...
        Action trajectoryAction10 = drive.actionBuilder(new Pose2d(27, 38,Math.toRadians(-52)))

                .strafeToConstantHeading(new Vector2d(74, 52))
                .build();

        Action trajectoryAction11 = drive.actionBuilder(new Pose2d(74, 52,Math.toRadians(-52)))

                .strafeToConstantHeading(new Vector2d(94, 26))
                .build();

        Action trajectoryAction12 = drive.actionBuilder(new Pose2d(94, 26.01,Math.toRadians(-52)))
        ...
        Action trajectoryAction12x = drive.actionBuilder(new Pose2d(94, 26,Math.toRadians(-52)))
                .stopAndAdd(()->
                        new RollerCommand(intake,Intake.IntakeRollerState.ON))
        ...
        Action trajectoryAction13 = drive.actionBuilder(new Pose2d(27, 38,Math.toRadians(-52)))
