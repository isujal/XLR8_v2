...
@Config
//@TeleOp(name = "TELEOP SB7", group = "TELEOP")
public class SB7 extends LinearOpMode {
        ...
        PIDThread = new Thread(() -> {
            while (!Thread.currentThread().isInterrupted() && opModeIsActive()) {
                try {
                    ...
                    telemetry.addData("counterFeed_GPPtoPPG   : ", Globals.counterFeed_GPPtoPPG);
                    telemetry.addData("counterFeed_GPPtoPGP  : ", Globals.counterFeed_GPPtoPGP);
                    telemetry.addData("counterFeed_PGPtoPPG  : ", Globals.counterFeed_PGPtoPPG);

                    telemetry.addData("intakeFlag_PGPtoPPG  : ", Globals.intakeFlag_PGPtoPPG);
                    telemetry.addData("counterFeed_PGPtoPPG  : ", Globals.intakeFlag_GPPtoPGP);
                    telemetry.addData("counterFeed_PGPtoPPG  : ", Globals.intakeFlag_GPPtoPPG);
...
//            }
//            if (!Globals.intakeFlag && !Globals.intakeFlag_PGPtoPPG && !Globals.intakeFlag_GPPtoPGP  && !Globals.intakeFlag_GPPtoPPG)
//            {
//                runningActions.add(
//                        new ParallelAction(
