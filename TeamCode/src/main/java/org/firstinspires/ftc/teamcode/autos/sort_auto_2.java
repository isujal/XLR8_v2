...
@Config
//@Autonomous(name="sort auto 2 🔴")
//@Deprecated
public class sort_auto_2 extends LinearOpMode {
    ...
    public static int intakeTimex = 1200;
...
//
        ...
        Action trajectoryAction7 = drive.actionBuilder(new Pose2d(8, 30,Math.toRadians(90)))
                ...
                .strafeToConstantHeading(new Vector2d(8, 60), vel, accel2)
                .build();
        ...
        Action trajectoryAction8x = drive.actionBuilder(new Pose2d(8, 60,Math.toRadians(90)))
                .stopAndAdd(()->
                        new RollerCommand(intake,Intake.IntakeRollerState.ON))
                .strafeToConstantHeading(new Vector2d(8, 60.01), vel, accel2)
                .waitSeconds(0.1)
                .stopAndAdd(()->Actions.runBlocking(new ParallelAction(
                        new InstantAction(()-> new RollerCommand(intake,Intake.IntakeRollerState.ON)),
                        new InstantAction(()-> new UFCommand(feeder,Feeder.UpperFeederState.OFF)),
...
////            }
//
//                    if (!robot.feederBeam.getState() && Globals.counterFeed_PGPtoPPG==0 && state == 3 ){
...
//
//                    }
//                    if (robot.feederBeam.getState() && Globals.counterFeed_PGPtoPPG ==1 && state == 3 ){
//                        Globals.counterFeed_PGPtoPPG += 1;
//                        Actions.runBlocking(
//                                new ParallelAction(
//                                        Feeder.UFCommand(Feeder.UpperFeederState.OFF),
...
//                    }
//
//                    if (Globals.counterFeed_PGPtoPPG==4 && !robot.intakeBeam.getState()&& state == 3 ){
//                        Globals.counterFeed_PGPtoPPG += 1;
////                zeroFlag = false;
//                        Actions.runBlocking(
//                                new ParallelAction(
...
//
//                    }
//                    if (Globals.counterFeed_PGPtoPPG==5 && robot.intakeBeam.getState()&& state == 3 ){
////                motionFlag = true;
////                motionTimer.reset();
//                        Globals.counterFeed_PGPtoPPG = 0;
//                        gamepad1.rumble(1,1,400);
...
//                motionTimer.reset();
                    ...
                    telemetry.addData("counterFeed 1",Globals.counterFeed_GPPtoPPG);
                    telemetry.addData("counterFeed 2",Globals.counterFeed_PGPtoPPG);
...
//            }
            ...
            if (state ==9 && intakeTimer.milliseconds()>intakeTimex)
            {
                ...
                Actions.runBlocking(
                        new SequentialAction(
                                ...
                                new InstantAction(()-> Globals.counterFeed_PGPtoPPG = 0)
                        )
                );
                intakeTimer.reset();
            }
