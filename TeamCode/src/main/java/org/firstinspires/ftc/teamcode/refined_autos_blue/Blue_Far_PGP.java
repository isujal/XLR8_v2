...
@Config
//@Autonomous(name="SB AUTO FAR SORT PGP🔵")
//@Deprecated
public class Blue_Far_PGP extends LinearOpMode {
    ...
    AccelConstraint accel = new ProfileAccelConstraint(-45,1);
...
//
        ...
        Action trajectoryAction2 = drive.actionBuilder(new Pose2d(30, -9,Math.toRadians(-90)))
        ...
        Action trajectoryAction3 = drive.actionBuilder(new Pose2d(30, -30,Math.toRadians(-90)))
                ...
                .strafeToConstantHeading(new Vector2d(30, -40), vel,accel2)
                .waitSeconds(0.2)
                .strafeToConstantHeading(new Vector2d(30, -60), vel,accel2)
                .build();
        ...
        Action trajectoryAction7 = drive.actionBuilder(new Pose2d(6, -30,Math.toRadians(-90)))
                ...
                .strafeToConstantHeading(new Vector2d(6, -60), vel, accel2)
                .build();
...
//                zeroFlag = true;
                    ...
                    if (Globals.counterFeed_GPPtoPPG==3 && !robot.intakeBeam.getState()&& state ==3){
                        Globals.counterFeed_GPPtoPPG += 1;
                        Actions.runBlocking(
                                new ParallelAction(
                                        Intake.IntakeCommand(Intake.IntakeServoState.IN),
