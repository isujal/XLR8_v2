...
//
        ...
        Action trajectoryAction14 = drive.actionBuilder(new Pose2d(57, -58,Math.toRadians(-100)))
                .stopAndAdd(()->Actions.runBlocking(new ParallelAction(
                        new InstantAction(()-> new RollerCommand(intake,Intake.IntakeRollerState.OFF)),
                        new InstantAction(()-> new UFCommand(feeder,Feeder.UpperFeederState.OFF)),
                        new InstantAction(()-> new LFCommand(feeder,Feeder.LowerFeederState.OFF))
...
//                .build();
//
//        Action trajectoryAction7 = drive.actionBuilder(new Pose2d(6, -30,Math.toRadians(-90)))
//
//                .strafeToConstantHeading(new Vector2d(6, -60),vel,accel)
//                .build();
//
//        Action trajectoryAction8 = drive.actionBuilder(new Pose2d(6, -60.01,Math.toRadians(-90)))
//
//                .strafeToConstantHeading(new Vector2d(47, -9))
//                .stopAndAdd(()->
//                        new TurretCommand(outtake, Outtake.TurretState.TRACK))
//                .build();
//
//
//        Action trajectoryAction8x = drive.actionBuilder(new Pose2d(6, -60,Math.toRadians(-90)))
//                .stopAndAdd(()->
//                        new RollerCommand(intake,Intake.IntakeRollerState.ON))
//                .strafeToConstantHeading(new Vector2d(6, -60.01))
//                .waitSeconds(0.1)
//                .stopAndAdd(()->Actions.runBlocking(new ParallelAction(
//                        new InstantAction(()-> new RollerCommand(intake,Intake.IntakeRollerState.ON)),
//                        new InstantAction(()-> new UFCommand(feeder,Feeder.UpperFeederState.OFF)),
...
//                    gamepad1.rumble(1, 1, 400);
                    ...
                    if (!robot.feederBeam.getState() && counterFeed == 0 && state == 10) {
                        counterFeed += 1;
                    ...
                    if (robot.feederBeam.getState() && counterFeed == 1 && state == 10   ) {
                        counterFeed += 1;
                        Actions.runBlocking(
                                new ParallelAction(
                                        Intake.IntakeCommand(Intake.IntakeServoState.IN),
                    ...
                    if (counterFeed == 2 && !robot.feederBeam.getState() && state == 10) {
                        counterFeed += 1;
                        Actions.runBlocking(
                                new ParallelAction(
                                        Intake.IntakeCommand(Intake.IntakeServoState.IN),
                    ...
                    if (counterFeed == 3 && robot.feederBeam.getState() && state == 10) {
                        counterFeed += 1;
                        Actions.runBlocking(
                                new ParallelAction(
                                        Intake.IntakeCommand(Intake.IntakeServoState.IN),
                    ...
                    if (counterFeed == 4 && !robot.intakeBeam.getState() && state == 10) {
                        counterFeed += 1;
                        Actions.runBlocking(
                                new ParallelAction(
                                        Intake.IntakeCommand(Intake.IntakeServoState.IN),
                    ...
                    if (counterFeed == 5 && robot.intakeBeam.getState() && state == 10) {
//                motionFlag = true;
//                motionTimer.reset();
                        counterFeed = 0;
//                    gamepad1.rumble(1, 1, 400);
                    ...
                    if (!robot.feederBeam.getState() && counterFeed == 0 && state == 15) {
                        counterFeed += 1;
                    ...
                    if (robot.feederBeam.getState() && counterFeed == 1 && state == 15   ) {
                        counterFeed += 1;
                        Actions.runBlocking(
                                new ParallelAction(
                                        Intake.IntakeCommand(Intake.IntakeServoState.IN),
                    ...
                    if (counterFeed == 2 && !robot.feederBeam.getState() && state == 15) {
                        counterFeed += 1;
                        Actions.runBlocking(
                                new ParallelAction(
                                        Intake.IntakeCommand(Intake.IntakeServoState.IN),
                    ...
                    if (counterFeed == 3 && robot.feederBeam.getState() && state == 15) {
                        counterFeed += 1;
                        Actions.runBlocking(
                                new ParallelAction(
                                        Intake.IntakeCommand(Intake.IntakeServoState.IN),
                    ...
                    if (counterFeed == 4 && !robot.intakeBeam.getState() && state == 15) {
                        counterFeed += 1;
                        Actions.runBlocking(
                                new ParallelAction(
                                        Intake.IntakeCommand(Intake.IntakeServoState.IN),
                    ...
                    if (counterFeed == 5 && robot.intakeBeam.getState() && state == 15) {
//                motionFlag = true;
//                motionTimer.reset();
                        counterFeed = 0;
//                    gamepad1.rumble(1, 1, 400);
...
//            robot.shooter.setVelocityPIDFCoefficients(P,I,D,F);
            ...
            if (state ==10 && intakeTimer.milliseconds()>intakeTime)
            {
                counterFeed = 0;
                state = 11;
                intakeTimer.reset();
            ...
            if (state ==15 && intakeTimer.milliseconds()>350)
            {
                counterFeed = 0;
                state = 16;
                intakeTimer.reset();
            ...
            if (state ==19 && intakeTimer.milliseconds()>200)
            {
                counterFeed = 0;
                state = 20;
                intakeTimer.reset();
...
//
//@Config
//@Autonomous(name="SB AUTO FAR SCRIM 🔵")
////@Deprecated
...
//                        )
//                )
//                .strafeToLinearHeading(new Vector2d(47,-33), Math.toRadians(-40))
//                .strafeToLinearHeading(new Vector2d(45, -26), Math.toRadians(-15),vel, accel)
//                .strafeToLinearHeading(new Vector2d(48, -26), Math.toRadians(-15))
//
//
////                .splineToLinearHeading(new Pose2d(70,70,Math.toRadians(45)), Math.toRadians(45), vel,accel)
//                .build();
////
//
//        Action trajectoryAction7 = drive.actionBuilder(new Pose2d(48, -26,Math.toRadians(-15)))
//                .stopAndAdd(()->Actions.runBlocking(new ParallelAction(
//                        new InstantAction(()-> new RollerCommand(intake,Intake.IntakeRollerState.OFF)),
//                        new InstantAction(()-> new UFCommand(feeder,Feeder.UpperFeederState.OFF)),
//                        new InstantAction(()-> new LFCommand(feeder,Feeder.LowerFeederState.OFF))
...
//
////
//        Action trajectoryAction8 = drive.actionBuilder(new Pose2d(47, -9,Math.toRadians(-90)))
//
//                .waitSeconds(0.5)
//                .stopAndAdd(()->Actions.runBlocking(new SequentialAction(
//                        new InstantAction(()-> new UFCommand(feeder,Feeder.UpperFeederState.ON)),
...
//                        )
//                )
//                .strafeToLinearHeading(new Vector2d(55, -55), Math.toRadians(-100),vel, accel0)
//
//
////                .splineToLinearHeading(new Pose2d(70,70,Math.toRadians(45)), Math.toRadians(45), vel,accel)
//                .build();
////
//
//        Action trajectoryAction10 = drive.actionBuilder(new Pose2d(55, -55,Math.toRadians(-100)))
//                .stopAndAdd(()->Actions.runBlocking(new ParallelAction(
//                        new InstantAction(()-> new RollerCommand(intake,Intake.IntakeRollerState.OFF)),
//                        new InstantAction(()-> new UFCommand(feeder,Feeder.UpperFeederState.OFF)),
//                        new InstantAction(()-> new LFCommand(feeder,Feeder.LowerFeederState.OFF))
...
//
//
//            if (state ==8 && intakeTimer.milliseconds()>1200)
//            {
//                counterFeed = 0;
//                state = 9;
//                intakeTimer.reset();
