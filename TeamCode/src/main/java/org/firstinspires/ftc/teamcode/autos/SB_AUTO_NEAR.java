...
//@Deprecated
public class SB_AUTO_NEAR extends LinearOpMode {
...
//        new InstantAction(() -> new RollerCommand(intake, Intake.IntakeRollerState.ON)),
        ...
        Action trajectoryAction0 = drive.actionBuilder(new Pose2d(0, 0,Math.toRadians(0)))
                ...
                .strafeToLinearHeading(new Vector2d(-8, -51.01), Math.toRadians(52))
        ...
        Action trajectoryAction = drive.actionBuilder(new Pose2d(-8, -51.01,Math.toRadians(52)))
                ...
                .waitSeconds(0.05)
                .stopAndAdd(()->
                        new TurretCommand(outtake, Outtake.TurretState.SHOOT_NEAR))
                .waitSeconds(0.05)
...
//
        ...
        Action trajectoryAction2 = drive.actionBuilder(new Pose2d(-8, -51,Math.toRadians(52)))

                .strafeToLinearHeading(new Vector2d(1, -43), Math.toRadians(52))
                .build();

        Action trajectoryAction3 = drive.actionBuilder(new Pose2d(1, -43,Math.toRadians(52)))

                .strafeToLinearHeading(new Vector2d(13, -25), Math.toRadians(52))
                .build();



        Action trajectoryAction4 = drive.actionBuilder(new Pose2d(13, -25.01,Math.toRadians(52)))
        ...
        Action trajectoryAction4x = drive.actionBuilder(new Pose2d(13, -25,Math.toRadians(52)))
                .stopAndAdd(()->
                        new RollerCommand(intake,Intake.IntakeRollerState.ON))
                .strafeToConstantHeading(new Vector2d(13, -25.01))
                .waitSeconds(0.1)
        ...
        Action trajectoryAction5 = drive.actionBuilder(new Pose2d(-8, -51,Math.toRadians(52)))
...
//
        ...
        Action trajectoryAction6 = drive.actionBuilder(new Pose2d(-8, -51,Math.toRadians(52)))

                .strafeToConstantHeading(new Vector2d(17, -61))
                .build();

        Action trajectoryAction7 = drive.actionBuilder(new Pose2d(17, -61,Math.toRadians(52)))

                .strafeToConstantHeading(new Vector2d(40, -37))
                .build();

        Action trajectoryAction8 = drive.actionBuilder(new Pose2d(40, -37.01,Math.toRadians(52)))
        ...
        Action trajectoryAction8x = drive.actionBuilder(new Pose2d(40, -37,Math.toRadians(52)))
                .stopAndAdd(()->
                        new RollerCommand(intake,Intake.IntakeRollerState.ON))
                .strafeToConstantHeading(new Vector2d(40, -37.01))
                .waitSeconds(0.1)
                .stopAndAdd(()->Actions.runBlocking(new ParallelAction(
                        new InstantAction(()-> new RollerCommand(intake,Intake.IntakeRollerState.ON)),
                        new InstantAction(()-> new UFCommand(feeder,Feeder.UpperFeederState.OFF)),
        ...
        Action trajectoryAction9 = drive.actionBuilder(new Pose2d(-8, -51,Math.toRadians(52)))
...
//                .waitSeconds(0.1)
        ...
        Action trajectoryAction10 = drive.actionBuilder(new Pose2d(-8, -51,Math.toRadians(52)))

                .strafeToConstantHeading(new Vector2d(37, -74))
                .build();

        Action trajectoryAction11 = drive.actionBuilder(new Pose2d(37, -74,Math.toRadians(52)))

                .strafeToConstantHeading(new Vector2d(57, -51))
                .build();

        Action trajectoryAction12 = drive.actionBuilder(new Pose2d(57, -51.01,Math.toRadians(52)))
        ...
        Action trajectoryAction12x = drive.actionBuilder(new Pose2d(57, -51,Math.toRadians(52)))
                .stopAndAdd(()->
                        new RollerCommand(intake,Intake.IntakeRollerState.ON))
                .strafeToConstantHeading(new Vector2d(57, -57.01))
                .waitSeconds(0.1)
                .stopAndAdd(()->Actions.runBlocking(new ParallelAction(
                        new InstantAction(()-> new RollerCommand(intake,Intake.IntakeRollerState.ON)),
                        new InstantAction(()-> new UFCommand(feeder,Feeder.UpperFeederState.OFF)),
        ...
        Action trajectoryAction13 = drive.actionBuilder(new Pose2d(-8, -51,Math.toRadians(52)))
