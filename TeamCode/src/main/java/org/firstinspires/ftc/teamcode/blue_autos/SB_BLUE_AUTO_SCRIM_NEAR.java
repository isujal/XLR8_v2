...
@Config
//@Autonomous(name="SB AUTO NEAR SCRIM 🔵")
//@Deprecated
public class SB_BLUE_AUTO_SCRIM_NEAR extends LinearOpMode {
...
//        new InstantAction(() -> new RollerCommand(intake, Intake.IntakeRollerState.ON)),
        ...
        Action trajectoryAction0 = drive.actionBuilder(new Pose2d(0, 0,Math.toRadians(0)))

                .strafeToLinearHeading(new Vector2d(27, 38.01), Math.toRadians(-46))
        ...
        Action trajectoryAction = drive.actionBuilder(new Pose2d(27, 38.01,Math.toRadians(-46)))
                ...
                .waitSeconds(0.05)
                .stopAndAdd(()->
                        new TurretCommand(outtake, Outtake.TurretState.BUFF_RED))
                .waitSeconds(0.05)
                .strafeToLinearHeading(new Vector2d(27,38), Math.toRadians(-46))
                .waitSeconds(0.1)
                .stopAndAdd(()->Actions.runBlocking(new SequentialAction(
                        new InstantAction(()-> new UFCommand(feeder,Feeder.UpperFeederState.ON)),
                        new SleepAction(0.3),
...
//
        ...
        Action trajectoryAction2 = drive.actionBuilder(new Pose2d(27, 38,Math.toRadians(-46)))

                .strafeToLinearHeading(new Vector2d(27, 38.01), Math.toRadians(-46))
                .build();

        Action trajectoryAction3 = drive.actionBuilder(new Pose2d(27, 38.01,Math.toRadians(-46)))

                .strafeToLinearHeading(new Vector2d(52, 9), Math.toRadians(-46))
                .build();



        Action trajectoryAction4 = drive.actionBuilder(new Pose2d(52, 9.01,Math.toRadians(-46)))

                .strafeToLinearHeading(new Vector2d(60, 15), Math.toRadians(-46))
                .stopAndAdd(()->
                        new TurretCommand(outtake, Outtake.TurretState.BUFF_RED))
                .build();


        Action trajectoryAction4x = drive.actionBuilder(new Pose2d(52, 9,Math.toRadians(-46)))
                .stopAndAdd(()->
                        new RollerCommand(intake,Intake.IntakeRollerState.ON))
                .strafeToConstantHeading(new Vector2d(52, 9.01))
                .waitSeconds(0.1)
        ...
        Action trajectoryAction5 = drive.actionBuilder(new Pose2d(27, 38,Math.toRadians(-46)))
...
//
        ...
        Action trajectoryAction6 = drive.actionBuilder(new Pose2d(60, 15,Math.toRadians(-46)))

                .strafeToConstantHeading(new Vector2d(63, 11))
                .build();

        Action trajectoryAction7 = drive.actionBuilder(new Pose2d(63, 11,Math.toRadians(-46)))
                .waitSeconds(1.3)

                .strafeToConstantHeading(new Vector2d(27, 38))
                .build();
//
        Action trajectoryAction8 = drive.actionBuilder(new Pose2d(27, 38,Math.toRadians(-46)))

                .strafeToConstantHeading(new Vector2d(53, 45))
                .build();

        Action trajectoryAction9 = drive.actionBuilder(new Pose2d(53, 45,Math.toRadians(-46)))

                .strafeToConstantHeading(new Vector2d(75, 20))
                .build();
//
        Action trajectoryAction10 = drive.actionBuilder(new Pose2d(75, 20.01,Math.toRadians(-46)))
...
//
//
        Action trajectoryAction10x = drive.actionBuilder(new Pose2d(75, 20,Math.toRadians(-46)))
                .stopAndAdd(()->
                        new RollerCommand(intake,Intake.IntakeRollerState.ON))
                .strafeToConstantHeading(new Vector2d(75, 20.01))
                .waitSeconds(0.1)
                .stopAndAdd(()->Actions.runBlocking(new ParallelAction(
                        new InstantAction(()-> new RollerCommand(intake,Intake.IntakeRollerState.ON)),
                        new InstantAction(()-> new UFCommand(feeder,Feeder.UpperFeederState.OFF)),
                ...
                .build();
//
        Action trajectoryAction11 = drive.actionBuilder(new Pose2d(27, 38,Math.toRadians(-46)))
...
//
//
//        Action trajectoryAction10 = drive.actionBuilder(new Pose2d(27, 38,Math.toRadians(-46)))
//
//                .strafeToConstantHeading(new Vector2d(74, 52))
//                .build();
//
//        Action trajectoryAction11 = drive.actionBuilder(new Pose2d(74, 52,Math.toRadians(-46)))
//
//                .strafeToConstantHeading(new Vector2d(94, 26))
//                .build();
//
//        Action trajectoryAction12 = drive.actionBuilder(new Pose2d(94, 26.01,Math.toRadians(-46)))
//
//                .strafeToConstantHeading(new Vector2d(27, 38))
//                .stopAndAdd(()->
//                        new TurretCommand(outtake, Outtake.TurretState.BUFF_RED))
...
//
//
//        Action trajectoryAction12x = drive.actionBuilder(new Pose2d(94, 26,Math.toRadians(-46)))
//                .stopAndAdd(()->
//                        new RollerCommand(intake,Intake.IntakeRollerState.ON))
//                .strafeToConstantHeading(new Vector2d(94, 26.01))
//                .waitSeconds(0.1)
//                .stopAndAdd(()->Actions.runBlocking(new ParallelAction(
//                        new InstantAction(()-> new RollerCommand(intake,Intake.IntakeRollerState.ON)),
//                        new InstantAction(()-> new UFCommand(feeder,Feeder.UpperFeederState.OFF)),
...
//                .build();
//
//        Action trajectoryAction13 = drive.actionBuilder(new Pose2d(27, 38,Math.toRadians(-46)))
//
//                .waitSeconds(0.2)
//                .stopAndAdd(()->Actions.runBlocking(new SequentialAction(
//                        new InstantAction(()-> new UFCommand(feeder,Feeder.UpperFeederState.ON)),
...
//                    gamepad1.rumble(1, 1, 400);
                ...
                if (intakeTimer.milliseconds()>intakeTime)
                {
                    counterFeed = 0;
                    state = 4;
                    intakeTimer.reset();
...
//
            if (state==12) {
                if (!robot.feederBeam.getState() && counterFeed == 0 && state == 9) {
                    counterFeed += 1;
                }
                if (robot.feederBeam.getState() && counterFeed == 1 && state == 9   ) {
                    counterFeed += 1;
                }
                if (counterFeed == 2 && !robot.feederBeam.getState() && state == 9) {
                    counterFeed += 1;
                }
                if (counterFeed == 3 && robot.feederBeam.getState() && state == 9) {
                    counterFeed += 1;
                    Actions.runBlocking(
                            new ParallelAction(
                                    Feeder.LFCommand(Feeder.LowerFeederState.OFF)
                ...
                if (counterFeed == 4 && !robot.intakeBeam.getState() && state == 9) {
                    counterFeed += 1;
                }
                if (counterFeed == 5 && robot.intakeBeam.getState() && state == 9) {
//                motionFlag = true;
//                motionTimer.reset();
                    counterFeed = 0;
//                    gamepad1.rumble(1, 1, 400);
