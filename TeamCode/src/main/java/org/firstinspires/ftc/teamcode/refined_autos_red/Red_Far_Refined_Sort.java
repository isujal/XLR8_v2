...
@Config
//@Autonomous(name="SB AUTO FAR SORT 🔴")
//@Deprecated
public class Red_Far_Refined_Sort extends LinearOpMode {
...
//                zeroFlag = true;
                    ...
                    if (Globals.counterFeed_GPPtoPPG==4 && !robot.feederBeam.getState()&& state ==3){
//                        Globals.counterFeed_GPPtoPPG += 1;
