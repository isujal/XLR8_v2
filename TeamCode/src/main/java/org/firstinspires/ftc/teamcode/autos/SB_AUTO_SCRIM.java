...
@Config
//@Autonomous(name="SB AUTO SCRIM 🔴")
//@Deprecated
public class SB_AUTO_SCRIM extends LinearOpMode {
...
//
        ...
        Action trajectoryAction2 = drive.actionBuilder(new Pose2d(47, 9,Math.toRadians(90)))
                ...
                .strafeToConstantHeading(new Vector2d(32, 29))
                .build();

        Action trajectoryAction3 = drive.actionBuilder(new Pose2d(32, 29,Math.toRadians(90)))
        ...
        Action trajectoryAction4 = drive.actionBuilder(new Pose2d(32, 60.01,Math.toRadians(90)))
        ...
        Action trajectoryAction4x = drive.actionBuilder(new Pose2d(32, 60,Math.toRadians(90)))
                .stopAndAdd(()->
                        new RollerCommand(intake,Intake.IntakeRollerState.ON))
                .strafeToConstantHeading(new Vector2d(32, 60.01))
                .waitSeconds(0.1)
...
//
        ...
        Action trajectoryAction7 = drive.actionBuilder(new Pose2d(62, 76,Math.toRadians(48)))

                .strafeToLinearHeading(new Vector2d(84, 78), Math.toRadians(0),vel, accel)
                .build();

        Action trajectoryAction7y = drive.actionBuilder(new Pose2d(84, 78,Math.toRadians(0)))

                .strafeToLinearHeading(new Vector2d(95, 77), Math.toRadians(0),vel, accel)
                .build();

        Action trajectoryAction8 = drive.actionBuilder(new Pose2d(98, 75,Math.toRadians(0)))
        ...
        Action trajectoryAction8x = drive.actionBuilder(new Pose2d(95, 77,Math.toRadians(0)))
                .stopAndAdd(()->
                        new RollerCommand(intake,Intake.IntakeRollerState.ON))
                .strafeToConstantHeading(new Vector2d(98, 75), vel, accel)
                .waitSeconds(0.1)
                .stopAndAdd(()->Actions.runBlocking(new ParallelAction(
                        new InstantAction(()-> new RollerCommand(intake,Intake.IntakeRollerState.ON)),
                        new InstantAction(()-> new UFCommand(feeder,Feeder.UpperFeederState.OFF)),
...
//
        ...
        Action trajectoryAction11 = drive.actionBuilder(new Pose2d(8, 30,Math.toRadians(90)))

                .strafeToConstantHeading(new Vector2d(8, 60))
                .build();

        Action trajectoryAction12 = drive.actionBuilder(new Pose2d(8, 60.01,Math.toRadians(90)))
        ...
        Action trajectoryAction12x = drive.actionBuilder(new Pose2d(8, 60,Math.toRadians(90)))
                .stopAndAdd(()->
                        new RollerCommand(intake,Intake.IntakeRollerState.ON))
