...
@Config
//@Autonomous(name="SB AUTO NEAR SORT GPP🔴")
//@Deprecated
public class Red_Near_Sort_GPP extends LinearOpMode {
...
//
        ...
        Action trajectoryAction3 = drive.actionBuilder(new Pose2d(-7, 16.01,Math.toRadians(90)))
                ...
                .strafeToLinearHeading(new Vector2d(-7, 55), Math.toRadians(90), vel, accel0)
...
//                    gamepad1.rumble(1, 1, 400);
                    ...
                    if (state ==9 && Globals.counterFeed_GPPtoPPG ==0)
                    {
//                thirdBallFlag = false;
...
//            }
                    ...
                    if (!robot.intakeBeam.getState() && Globals.counterFeed_GPPtoPPG==0 && state ==9){
                    ...
                    if (robot.intakeBeam.getState() && Globals.counterFeed_GPPtoPPG ==1 && state ==9){
                        Globals.counterFeed_GPPtoPPG += 1;
                        Actions.runBlocking(
                                new ParallelAction(
                                        Intake.IntakeCommand(Intake.IntakeServoState.IN),
                    ...
                    if (Globals.counterFeed_GPPtoPPG==2 && !robot.feederBeam.getState()&& state ==9){
                        Globals.counterFeed_GPPtoPPG += 1;
                        Actions.runBlocking(
                                new ParallelAction(
                                        Intake.IntakeCommand(Intake.IntakeServoState.IN),
...
//                zeroFlag = true;
                    ...
                    if (Globals.counterFeed_GPPtoPPG==3 && robot.feederBeam.getState()&& state ==9){
                        Globals.counterFeed_GPPtoPPG += 1;
                        Actions.runBlocking(
                                new ParallelAction(
                                        Intake.IntakeCommand(Intake.IntakeServoState.IN),
                    ...
                    if (Globals.counterFeed_GPPtoPPG==4 && !robot.feederBeam.getState()&& state ==9){
//                        Globals.counterFeed_GPPtoPPG += 1;
