...
//@Deprecated
public class Red_Near_Scrim extends LinearOpMode {
...
//
        ...
        Action trajectoryAction3 = drive.actionBuilder(new Pose2d(-7, 16.01,Math.toRadians(90)))
                ...
                .strafeToLinearHeading(new Vector2d(-7, 57), Math.toRadians(90), vel, accel)
        ...
        Action trajectoryAction4 = drive.actionBuilder(new Pose2d(-7, 57,Math.toRadians(90)))
...
//                )
        ...
        Action trajectoryAction7 = drive.actionBuilder(new Pose2d(18, 60,Math.toRadians(90)))
...
//                )
        ...
        Action trajectoryActionend = drive.actionBuilder(new Pose2d(-7, 16,Math.toRadians(90)))
        ...
        Action trajectoryAction10 = drive.actionBuilder(new Pose2d(40.5, 58,Math.toRadians(90)))
